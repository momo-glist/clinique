...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    if (!idClinique || !idAdminClinique || !token) {
      console.error("ID admin clinique, ID clinique ou token JWT non disponible. Redirection vers la page de connexion.");
  ...
  }, [basePath, idAdminClinique, idClinique, navigate]);
    ...
    <div className="sidebar">
      ...
      <div className="center">
        <ul>
          ...
          <Link to={`/infirm`} style={{ textDecoration: 'none' }}>
            <li>
              <HomeRoundedIcon className="icon" />
              <span>Ajouter un Patient</span>
            </li>
          </Link>
          <Link to={`/infirm/patient`} style={{ textDecoration: 'none' }}>
            <li>
              <GroupIcon className="icon" />
              <span>Mes patiens</span>
            </li>
          </Link>
          <Link to={`/infirm/arch`} style={{ textDecoration: 'none' }}>
            <li>
              <ArchiveRoundedIcon className="icon" />
              <span>Archive</span>
            </li>
          </Link>
          <Link to={`/infirm/agenda`} style={{ textDecoration: 'none' }}>
            <li>
