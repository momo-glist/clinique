    ...
    <div className="sidebar">
      ...
      <div className="center">
        <ul>
          ...
          <Link to={`/comptable/ajout`} style={{ textDecoration: 'none' }}>
            <li>
              <AddIcon className="icon" />
              <span>Ajouter</span>
            </li>
          </Link>
          <p className="title">Salaires</p>
          <Link to={`/comptable/salaire`} style={{ textDecoration: 'none' }}>
            <li>
              <AttachMoneyIcon className="icon" />
              <span>Payer les salaires</span>
            </li>
          </Link>
          <Link to={`/comptable/avance`} style={{ textDecoration: 'none' }}>
            <li>
